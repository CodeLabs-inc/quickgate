...
export function BarChartBig({ chartData }: BarChartBigProps) {
        ...
        <Card style={{ width: "100%", padding: "10px" }}>
            <CardHeader className="w-full flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
                    <p style={{ fontSize: '20px', textAlign: 'left', width: '100%' }}>Ultimos 7 dias</p>
                    <CardDescription>
                        Distribucion de transito de los ultimos 7 dias
                    </CardDescription>
                </div>
                <div className="flex">
                    {["desktop"].map((key) => {
